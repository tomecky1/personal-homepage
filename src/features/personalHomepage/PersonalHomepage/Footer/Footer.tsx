...
export const Footer = () => {
  return (
    <Wrapper>
      <LetsTalk>Thank you for visiting my portfolio!</LetsTalk>
      <Address>
        <EmailWrapper>
        ...
        <Paragraph>
          ...
          see on my portfolio or review, also any inquiries that you may have,
        ...
        <SocialIcons>
          ...
          <Link
            href={"https://www.linkedin.com/in/tomasz-piotrowski-50821a331"}
            rel={"noreferrer"}
            target="_blank"
          >
